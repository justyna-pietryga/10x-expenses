    ...
    <section className="rounded-[28px] border border-white/12 bg-white/8 p-6 shadow-[0_20px_70px_rgba(2,6,23,0.35)] backdrop-blur-xl">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <h2 className="mt-2 text-2xl font-semibold text-white">Trusted reviewed expense category totals only.</h2>
          <p className="mt-2 text-sm leading-6 text-slate-300/80">
            Reviewed imported income feeds the income basis separately. Included reviewed uncategorized expense spend
            stays separate, and excluded transactions are reconciled outside this table.
          </p>
        </div>
        <div className="rounded-full border border-white/12 bg-slate-950/30 px-4 py-2 text-sm text-slate-200">
          Reviewed uncategorized expense spend: {formatAmount(reviewedUncategorizedSpend)}
        </div>
      </div>
