...
| UX-02      | import-review-rule-application    | Add field-aware import rules and current-batch rule application                | yes                   | Implemented; archive pending              |
...
| UX-05      | transaction-inclusion-control     | Let users exclude imported rows from budget calculations without deleting them | yes                   | Implemented; archive pending              |
